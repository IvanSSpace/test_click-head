...
const Card: React.FC<CardProps> = ({ title, price, id }) => {
  ...
  return (
    <div onClick={handleClick} className="flex flex-col justify-between max-w-[320px] bg-white p-4 shadow-lg rounded-lg">
      <div className='pb-3'>
